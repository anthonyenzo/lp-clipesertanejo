...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="section receive-section"><div className="shell receive-grid"><Reveal className="pack-visual"><div className="pack-orbit orbit-one" /><div className="pack-orbit orbit-two" /><div className="pack-box"><span className="pack-brand">BrazHits</span><strong><small>PACK</small> +2.000<br />CLIPES</strong><span className="pack-quality">FULL HD • 1080P</span><div className="pack-disc"><span>BH</span></div></div><div className="mini-stat stat-one"><strong>MP4</strong><span>Formato universal</span></div><div className="mini-stat stat-two"><strong>VIP</strong><span>Grupo de atualizações</span></div></Reveal><Reveal className="receive-copy" delay={100}><SectionTitle eyebrow="Tudo em um só lugar" title={<>Veja o que você vai <span>receber.</span></>} /><p>O maior acervo de clipes da BrazHits, preparado para você baixar com segurança e usar com total liberdade.</p><ul className="check-list two-columns"><CheckItem>Mais de 2.000 clipes</CheckItem><CheckItem>Pastas organizadas</CheckItem><CheckItem>Vários gêneros musicais</CheckItem><CheckItem>MP4 Full HD 1080p</CheckItem><CheckItem>Compatível com carro e TV</CheckItem><CheckItem>Compatível com PC</CheckItem><CheckItem>Grupo VIP no WhatsApp</CheckItem><CheckItem>Atualizações mensais</CheckItem></ul><a className="text-link" href="#oferta-completa">Ver condições da oferta <ArrowIcon direction="down-right" /></a></Reveal></div></section>
