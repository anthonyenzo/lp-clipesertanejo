...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="final-cta"><div className="final-glow" /><div className="shell final-inner"><Reveal><span className="eyebrow">Dê o play na sua experiência</span><h2>Mais de 2.000 clipes.<br /><span>Um clique de distância.</span></h2><p>Aproveite a oferta de hoje e receba seu acesso imediatamente após a confirmação.</p><a className="cta cta-large" href="#oferta-completa">Garantir meu Pack agora <ArrowIcon /></a></Reveal></div></section>
        ...
        <div className="upgrade-modal" role="presentation" onMouseDown={(event) => { if (event.target === event.currentTarget) setUpgradeOpen(false); }}>
          <div ref={upgradeDialogRef} className="upgrade-dialog" role="dialog" aria-modal="true" aria-labelledby="upgrade-title" aria-describedby="upgrade-description" tabIndex={-1}>
            ...
            <div className="upgrade-highlight">
              <div><strong>+2.000</strong><span>clipes em MP4<br />Full HD 1080p</span></div>
              <ul>
                <li><span>✓</span> Todos os 8 packs da loja</li>
            ...
            <a className="cta upgrade-accept" href={CHECKOUT_TODOS_CLIPES_ESPECIAL} target="_blank" rel="noopener noreferrer" onClick={() => setUpgradeOpen(false)}>Sim, quero +2.000 clipes por R$ 57 <ArrowIcon /></a>
            <a className="upgrade-decline" href={CHECKOUT_COMPLETO} target="_blank" rel="noopener noreferrer" onClick={() => setUpgradeOpen(false)}>Não, continuar com Clipes + Músicas Sertanejas por R$ 26,90</a>
