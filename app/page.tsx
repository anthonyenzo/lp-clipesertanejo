  ...
  return (
    <main>
      ...
      <section className="section pricing" id="super-oferta"><div className="shell"><Reveal><SectionTitle eyebrow="Escolha sua oferta" title={<>Um pagamento. <span>Seu som completo, sem mensalidade.</span></>} text="Acesso imediato e vitalício. Escolha a opção que combina com você." /></Reveal><div className="pricing-grid">
        ...
        <Reveal id="oferta-completa" className="price-card ultimate" delay={200}><div className="recommended">MELHOR CUSTO-BENEFÍCIO</div><div className="discount-chip">30% OFF</div><div className="plan-label">PACK TOTAL BRAZHITS</div><h3>Todos os Clipes</h3><p className="plan-description">O maior acervo da BrazHits: todos os gêneros reunidos em uma única compra.</p><div className="ultimate-highlight"><strong>+1.500</strong><span>clipes em MP4<br />Full HD 1080p</span></div><ul className="check-list"><CheckItem><strong>Todos os 6 Packs de Clipes</strong></CheckItem><CheckItem>Organizados em pastas por gênero</CheckItem><CheckItem>Acesso vitalício</CheckItem><CheckItem>Garantia de 15 dias</CheckItem></ul><div className="genre-pills" aria-label="Gêneros incluídos"><span>Sertanejo 2026</span><span>Sertanejo Raiz</span><span>Pagode 2026</span><span>Forró e Arrocha</span><span>Gospel 2026</span><span>Rock Nacional</span></div><div className="saving-line">Você economiza <strong>R$ 30</strong></div><div className="price-old">Separados sairiam por <s>R$ 97,00</s></div><div className="price"><span>R$</span><strong>67</strong><sup>,00</sup></div><a className="cta price-button" href={CHECKOUT_TODOS_CLIPES} target="_blank" rel="noopener noreferrer">Quero todos os clipes <ArrowIcon /></a><div className="payment-note">PIX ou cartão • acesso imediato</div></Reveal>
      ...
      <a className="mobile-sticky-cta" href="#oferta-completa"><span><small>Pack Total • 30% OFF</small><strong>R$ 67,00</strong></span><b>VER OFERTA <ArrowIcon /></b></a>
    </main>
  );
}
